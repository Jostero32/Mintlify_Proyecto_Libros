...
El proyecto está empaquetado con **Docker Compose** y se levanta con un único comando. Esta página documenta la configuración real definida en [docker-compose.yml](https://github.com/jostero32/mintlify_proyecto_libros/blob/main/docker-compose.yml) y el [Dockerfile](https://github.com/jostero32/mintlify_proyecto_libros/blob/main/Dockerfile) de la API.
...
| ------------- | ---------------- | ------------------------------------------ | -------------------------------------------- |
| `PORT`        | `4040`           | [src/index.js:37](https://github.com/jostero32/mintlify_proyecto_libros/blob/main/src/index.js#L37) | Puerto HTTP de Express.       |
| `DB_HOST`     | `db`             | [src/config/database.js](https://github.com/jostero32/mintlify_proyecto_libros/blob/main/src/config/database.js) | Hostname del contenedor de Postgres dentro de la red Compose. |
...
El [Dockerfile](https://github.com/jostero32/mintlify_proyecto_libros/blob/main/Dockerfile) es minimalista:
