...
<Tip>
  La navegación práctica de la relación (cómo listar los libros de un autor desde el cliente) está documentada en [Relación Autor ↔ Libros](/api-reference/relacion).
</Tip>
