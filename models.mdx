...
La capa de persistencia usa **Sequelize 6** sobre PostgreSQL 16. Los modelos viven en [src/models/](https://github.com/jostero32/mintlify_proyecto_libros/blob/main/src/models/) y se registran en [src/config/database.js](https://github.com/jostero32/mintlify_proyecto_libros/blob/main/src/config/database.js).
...
Definido en [src/models/autor.model.js](https://github.com/jostero32/mintlify_proyecto_libros/blob/main/src/models/autor.model.js). Tabla SQL: `autores`.
...
Definido en [src/models/libro.model.js](https://github.com/jostero32/mintlify_proyecto_libros/blob/main/src/models/libro.model.js). Tabla SQL: `libros`.
...
Definida en [src/config/database.js](https://github.com/jostero32/mintlify_proyecto_libros/blob/main/src/config/database.js):
...
La API ejecuta `sequelize.sync({ alter: true })` al arrancar ([initDatabase](https://github.com/jostero32/mintlify_proyecto_libros/blob/main/src/config/database.js#L32)). Esto crea las tablas si no existen y ajusta columnas si cambiaron. No hay migraciones manuales.
...
Al arrancar, se ejecuta [src/config/seed.js](https://github.com/jostero32/mintlify_proyecto_libros/blob/main/src/config/seed.js) solo si las tablas están vacías. Carga un set inicial de autores y libros de prueba (Gabriel García Márquez, Isaac Asimov, etc.).
